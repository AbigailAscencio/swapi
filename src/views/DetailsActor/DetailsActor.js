          ...
          actor && (
            <div className="actor">
              ...
              <div className="actor__details">
                <div>
                  <p className="actor__detail">Altura: {actor.height}</p>
                  <p className="actor__detail">Masa: {actor.mass}</p>
                  <p className="actor__detail">Color de cabello: {actor.hair_color}</p>
                </div>
                <div>
                  <p className="actor__detail">Color de ojos: {actor.skin_color}</p>
                  <p className="actor__detail">Año de nacimiento: {actor.birth_year}</p>
                  <p className="actor__detail">Genero: {actor.gender}</p>
                </div>
              </div>
            </div>
          )
